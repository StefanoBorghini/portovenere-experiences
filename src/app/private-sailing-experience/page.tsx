    ...
    <main className="bg-white text-black">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="space-y-16 text-left">
            ...
            <div>
              ...
              <p className="text-lg leading-9 text-neutral-700">
                Slow navigation along dramatic cliffs and picturesque
      ...
      <section className="py-32 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg leading-9 text-neutral-700 mb-8">
            Enjoy fresh local seafood, Ligurian specialties and regional wines
            surrounded by the unique atmosphere of the Gulf of Poets.
          </p>

          <p className="text-lg leading-9 text-neutral-700">
            Restaurant reservation and coordination are included.
            Lunch is paid directly at the restaurant with à la carte selection.
          </p>
      ...
      <section className="py-32 px-6 bg-neutral-100 text-center">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <button className="bg-black text-white px-10 py-5 rounded-full text-lg hover:bg-neutral-800 transition-all">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8 text-lg leading-9 text-neutral-700">
            ...
            <p>
              ...
              perspective of the Gulf of Poets, including hidden coves and
              scenic coastal areas reachable only by sea.
            </p>
