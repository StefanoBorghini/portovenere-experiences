    ...
    <main className="bg-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <video
          ...
          muted
          loop
          poster="/videos/Istantanea.png"
          playsInline
          className="absolute inset-0 w-full h-full object-cover scale-105"
        >
          <source
            src="/videos/verna.mp4"
            type="video/mp4"
          />
        </video>
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* CARD 1 */}
          <div className="group relative overflow-hidden rounded-[40px] h-[700px]">
            <img
      ...
      <section
        id="contact"
        className="py-40 px-6 text-center bg-black border-t border-white/10"
      >
        <p className="uppercase tracking-[0.4em] text-zinc-500 text-sm mb-6">
          Private Access
        </p>
        ...
        <p className="max-w-2xl mx-auto text-zinc-400 text-lg leading-relaxed mb-12">
          Speak with our concierge team to curate your private experience in
