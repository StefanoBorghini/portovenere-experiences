...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Stesso ricalcolo server-side di /api/request-booking — le
    // modifiche possono cambiare esperienze/enhancement scelti, quindi
    // confirmed_selection.experienceDetails/enhancementDetails (letti
    // dai reminder e mostrati nella mail di conferma modifiche) vanno
    // rigenerati, non lasciati con i valori della richiesta precedente.
