...
const PLAN_OPTIONS: PlanOption[] = [
  ...
  { value: "premium", name: "Premium", price: "€240 / anno", tagline: "Per chi vuole essere promosso." },
  {
    ...
    name: "Signature",
    price: "Su richiesta",
    tagline: "Pensato per le realtà che desiderano una collaborazione strategica.",
    bullets: [
      "Campagne dedicate",
      "Progetti speciali",
      "Consulenza digitale",
    ...
    closingNote: "Collaborazione su misura.",
  },
              ...
              >
                {plan.value === "not_sure" ? (
                  ...
                  <>
                      ...
                      >
                        {plan.bullets.map((bullet) => (
                          <li key={bullet} className="flex items-start gap-2">
                            <span className="mt-2 h-1 w-1 rounded-full bg-current shrink-0" />
                    ...
                    {plan.closingNote && (
                      <span
                        className={`block text-sm mt-3 italic break-words ${
                          planInterest === plan.value ? "text-black/60" : "text-zinc-500"
                        }`}
                      >
                        {plan.closingNote}
